...
export const awardItems: BentoItem[] = [
  {
    ...
    type: "stats",
    size: "tall",
    logoUrl: "/lovable-uploads/time-inc-logo.webp",
  ...
  },
  {
    ...
    type: "stats",
    size: "medium",
    logoUrl: "/lovable-uploads/business-insider-logo.webp",
...
export const mediaLogosItem: BentoItem = {
  ...
  title: "Featured In",
  logos: [
    { name: "Forbes", url: "/lovable-uploads/3c6d8a93-ffcd-4d1e-ab79-30730f5a8bc3.webp" },
    { name: "Bloomberg", url: "/lovable-uploads/bloomberg-preview.webp" },
    { name: "CNN", url: "/lovable-uploads/c0ae8564-b87c-49b6-87e1-f959e7949cd9.webp" },
    { name: "Wired", url: "/lovable-uploads/wired-logo.webp" },
    { name: "Tech in Asia", url: "/lovable-uploads/675c8d4a-900e-4b8e-8ae6-0dadf20c0648.webp" },
    { name: "The Verge", url: "/lovable-uploads/face-detection-verge.jpg" },
    // Additional logos from home page
    { name: "Entrepreneur", url: "/lovable-uploads/1e9233d3-5592-410f-914c-aedf10827631.webp" },
    { name: "Esquire", url: "/lovable-uploads/9a8c7dcf-ce96-4254-882b-d04aa9cf534b.webp" },
    { name: "Fast Company", url: "/lovable-uploads/a51ada11-80d2-4476-b764-841b30596518.webp" },
  ],
  source: "static",
  order: 30,
};
...
export const speakingClientsItem: BentoItem = {
  ...
  logos: [
    { name: "Bank of America", url: "/lovable-uploads/66ad1914-4df8-42f6-b3a5-2a96f74a6f78.webp" },
    { name: "Stanford", url: "/lovable-uploads/ee34652c-0e56-40b5-a5f7-a8ed3c7a1a6c.webp" },
    { name: "Stryker", url: "/lovable-uploads/a5d82c6b-f512-43a4-a938-88135016f1e7.webp" },
    { name: "Citywire", url: "/lovable-uploads/b934d438-dc2c-472c-95c8-a8a1bc1de795.webp" },
    { name: "Singularity U", url: "/lovable-uploads/2949721d-3613-4262-b4b3-abf89eb5003d.webp" },
    { name: "Carnegie Mellon", url: "/lovable-uploads/ee34652c-0e56-40b5-a5f7-a8ed3c7a1a6c.webp" },
  ],
  source: "static",
  featured: true,
...
export const techstarsItem: BentoItem = {
  ...
  type: "stats",
  size: "medium",
  logoUrl: "/lovable-uploads/techstars-logo.webp",
